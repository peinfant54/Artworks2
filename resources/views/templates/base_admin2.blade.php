        ...
        <div class="navbar-collapse navbar-ex1-collapse collapse" style="height: 1px;">
            ...
            <form class="navbar-form navbar-right" role="search" style="margin-right: -30px;">
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="@lang('index.SearchPlaceHolder')" title="@lang('index.SearchLeyend')">
                </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @foreach (Config::get('languages') as $lang => $language)
                    @if ($lang != App::getLocale())
                        <li>
                            <a href="{{ route('lang.switch', $lang) }}" title="@lang('index.LanguageLeyend')">{{$language}}</a>
                        </li>
                    @endif
                @endforeach
                <li style="padding-top: 12px">
                    <p data-placement="top">
                        <button class="btn btn-primary btn-xs" data-title="Edit" name="ChangePass" data-toggle="modal" data-target="#change" title="@lang('index.ChangePasswordMsg')">
